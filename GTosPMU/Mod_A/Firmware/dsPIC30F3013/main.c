...
//// MCU "FUSE" Power Up Directives
// Not Using Internal Fast RC Oscillator @ 7.37 MHz  _FOSC(CSW_FSCM_OFF & FRC);
// External Clock Oscillator @ 12.000 MHz *PLL8 = 96 MHz (24 MIPS)
...
//// Firmware Version
volatile unsigned int THIS_VER = 0x090C;
#define GPS_OPT 0x00
//#define GPS_OPT 0x03
...
volatile unsigned int SERIAL_NBR = 0x0200;
